...
last_distance = 0#distance of car from goal
...
class Car(Widget):
    ...
    signal1 = NumericProperty(0) # initializing the signal received by sensor 1- density of sand 
    ...
    def move(self, rotation):
        ...
        self.sensor1 = Vector(30, 0).rotate(self.angle) + self.pos # updating the position of sensor 1 30 is the distance between the car and what the car detects
